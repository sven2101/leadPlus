...
function config($translateProvider) {
    ...
    $translateProvider
        .translations(Language[Language.DE], {
            ...
            REGISTRATION_SUBDOMAIN_AGREEMENT: "Ich stimme den <a href='#/licences/agb' target='_blank'>Nutztungsbedingungen</a> und der <a href='#/licences/DataProtection' target='_blank'>Datenschutzerklärung</a> zu",
        ...
        .translations(Language[Language.EN], {
            ...
            REGISTRATION_SUBDOMAIN_AGREEMENT: "I agree to the <a href='#/licences/agb' target='_blank'>General Terms and Conditions</a> and <a href='#/licences/DataProtection' target='_blank'>privacy policy</a>",
