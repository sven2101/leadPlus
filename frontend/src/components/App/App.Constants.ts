...
const moduleAttachment: string = moduleApp + ".attachment";
const moduleAttachmentResource: string = moduleAttachment + ".resource";
const moduleAttachmentService: string = moduleAttachment + ".service";
...
const moduleNgDropzone: string = "ngDropzone";
