...
/// <reference path="../models/Offer.ts" />
/*******************************************************************************
...
OffersCtrl.$inject = ['DTOptionsBuilder', 'DTColumnBuilder', '$compile',
	...
	'UserResource', '$rootScope', '$translate', 'OfferResource', 'ProductService', 'WorkflowService'];
...
OffersCtrl.prototype.getOrderPositions = function (process) {
