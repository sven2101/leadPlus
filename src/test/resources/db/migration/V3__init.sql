...
(
  id bigint NOT NULL DEFAULT nextval('template_id_seq'),
...
(
  id bigint NOT NULL DEFAULT nextval('"fileupload_id_seq"'),
  content bytea,
  deleted boolean NOT NULL,
...
(
  id bigint NOT NULL DEFAULT nextval('orderposition_id_seq'),
...
(
  id bigint NOT NULL DEFAULT nextval('process_id_seq'),
  deleted boolean NOT NULL,
...
CREATE TABLE smtp
(
  id bigint NOT NULL DEFAULT nextval('smtp_id_seq'),
...
(
  id bigint NOT NULL DEFAULT nextval('olap_id_seq'),
