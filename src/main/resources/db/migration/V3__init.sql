...
-- Products
INSERT INTO public.product(deactivated, description, name, pricenetto, timestamp, productstate, deleted)
...
INSERT INTO public.vendor(name, phone,deleted)
 ...
 -- Leads
 INSERT INTO public.lead(deleted, deliveryaddress, deliverycosts, message, timestamp, customer_fk, vendor_fk)
   	VALUES (false, '7011 Stuttgart, Einsiedlerweg 1', 300, 'Wichtige Anfrage!', '2016-03-26 12:23:00', 1, 1);
   	
INSERT INTO public.lead(deleted, deliveryaddress, deliverycosts, message, timestamp, customer_fk, vendor_fk)
   	VALUES (false, '76133 Karlsruhe, Hauptstrasse 55', 300, 'Wichtige Anfrage!', '2016-04-26 12:23:00', 2, 1);

INSERT INTO public.lead(deleted, deliveryaddress, deliverycosts, message, timestamp, customer_fk, vendor_fk)
   	VALUES (false, '10115 Berlin, Hauptstrasse 10', 300, 'Wichtige Anfrage!', '2016-05-25 12:23:00', 3, 1);
   	
INSERT INTO public.lead(deleted, deliveryaddress, deliverycosts, message, timestamp, customer_fk, vendor_fk)
   	VALUES (false, '20113 Hamburg, Einsiedlerweg 1', 300, 'Wichtige Anfrage!', '2016-06-06 12:23:00', 4, 1);
   	
INSERT INTO public.lead(deleted, deliveryaddress, deliverycosts, message, timestamp, customer_fk, vendor_fk)
   	VALUES (false, '10115 Berlin, Hauptstrasse 10', 300, 'Wichtige Anfrage!', '2016-08-30 12:23:00', 3, 1);
   	
INSERT INTO public.lead(deleted, deliveryaddress, deliverycosts, message, timestamp, customer_fk, vendor_fk)
   	VALUES (false, '20113 Hamburg, Einsiedlerweg 1', 300, 'Wichtige Anfrage!', '2016-09-16 12:23:00', 4, 1);
   	
INSERT INTO public.lead(deleted, deliveryaddress, deliverycosts, message, timestamp, customer_fk, vendor_fk)
   	VALUES (false, '20113 Hamburg, Einsiedlerweg 1', 300, 'Wichtige Anfrage!', '2016-09-25 12:23:00', 2, 1);
   	
INSERT INTO public.lead(deleted, deliveryaddress, deliverycosts, message, timestamp, customer_fk, vendor_fk)
   	VALUES (false, '20113 Hamburg, Einsiedlerweg 1', 300, 'Wichtige Anfrage!', '2016-09-26 12:23:00', 2, 1);
   	
INSERT INTO public.lead(deleted, deliveryaddress, deliverycosts, message, timestamp, customer_fk, vendor_fk)
   	VALUES (false, '20113 Hamburg, Einsiedlerweg 1', 300, 'Wichtige Anfrage!', '2016-09-25 12:23:00', 4, 1);
...
INSERT INTO public.lead(deleted, deliveryaddress, deliverycosts, message, timestamp, customer_fk, vendor_fk)
   	VALUES (false, '20113 Hamburg, Einsiedlerweg 1', 300, 'Wichtige Anfrage!', '2016-09-24 12:23:00', 4, 1);
   	
INSERT INTO public.lead(deleted, deliveryaddress, deliverycosts, message, timestamp, customer_fk, vendor_fk)
   	VALUES (false, '20113 Hamburg, Einsiedlerweg 1', 300, 'Wichtige Anfrage!', '2016-08-30 12:23:00', 5, 1);
     	
INSERT INTO public.lead(deleted, deliveryaddress, deliverycosts, message, timestamp, customer_fk, vendor_fk)
   	VALUES ( false, '20113 Hamburg, Einsiedlerweg 1', 300, 'Wichtige Anfrage!', '2016-08-30 12:23:00', 3, 1); 
   	
INSERT INTO public.lead(deleted, deliveryaddress, deliverycosts, message, timestamp, customer_fk, vendor_fk)
   	VALUES (false, '20113 Hamburg, Einsiedlerweg 1', 300, 'Wichtige Anfrage!', '2016-09-13 12:23:00', 1, 1);

-- Offer
-- INSERT INTO public.offer( id, deleted, delivery_address, delivery_costs, message, timestamp, customer_fk, vendor_fk, delivery_date, offer_price)
--    VALUES (1, false, '20113 Hamburg, Einsiedlerweg 1', 300, 'Wichtige Anfrage!', '2016-09-13 12:23:00', 1, 1, '2016-09-13 12:23:00', 2000);

-- Processes
INSERT INTO public.process(deleted, status, lead_fk)
    VALUES (false, 'OPEN', 1);
