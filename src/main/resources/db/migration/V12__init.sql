...
UPDATE offer 
SET net_price = net_price - deliverycosts
WHERE net_price is not null AND net_price > 0;

UPDATE template
SET content = REPLACE(content, 'workflow.deliveryAddress', 'workflow.deliveryAddressLine')
