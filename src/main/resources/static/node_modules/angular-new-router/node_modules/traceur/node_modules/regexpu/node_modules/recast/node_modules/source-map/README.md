...
* `username`: The original identifier, or null if this information is not available.
...
* `username`: An optional original token username for this mapping.
...
#### new SourceNode(line, column, source[, chunk[, username]])
...
* `username`: Optional. The original identifier.
...
To add new tests, create a new file named `test/test-<your new test username>.js`
