...
* Changed `language` option username to `locale` to be inline with moment naming
...
#### 2.1.30
##### Important! `build.less` file username has been been changed to `bootstrap-datetimepicker-build.less` to prevent collisions
