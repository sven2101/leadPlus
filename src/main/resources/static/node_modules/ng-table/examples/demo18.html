    ...
    <table ng-table="tableParams" class="table">
        <thead>
            <tr>
                <th class="sortable" ng-class="{
                    ...
                    ng-click="tableParams.sorting({'username' : tableParams.isSortBy('username', 'asc') ? 'desc' : 'asc'})" rowspan="2">
        ...
        <tbody>
            <tr ng-repeat="user in $data">
                <td data-title="'Name'" sortable="'username'">
                    {{user.username}}
                </td>
    ...
    <script>
        var app = angular.module('main', ['ngTable'])
                .controller('DemoCtrl', function($scope, NgTableParams, $filter) {
                    var data = [{username: "Moroni", age: 50},
