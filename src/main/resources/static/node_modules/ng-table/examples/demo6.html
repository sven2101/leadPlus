        ...
        <div loading-container="tableParams.settings().$loading">
            <table ng-table="tableParams" show-filter="true" class="table">
                <tr ng-repeat="user in $data">
                    <td data-title="'Name'" filter="{ 'username': 'text' }" sortable="'username'" sort-indicator="'span'">
                        {{user.username}}
                        {{$loading}}
                    </td>
                ...
                $httpBackend.whenGET(/data.*/).respond(function(method, url, data, headers) {
                    ...
                    for (var key in requestParams) {
                        if (key.indexOf('[') >= 0) {
                            ...
                            angular.forEach(params.reverse(), function(username) {
                                if (username != '') {
                                    var v = value;
                                    value = {};
                                    value[lastKey = username] = isNumber(v) ? parseFloat(v) : v;
                                }
                            });
                    ...
                    data = [{username: "Moroni", age: 50},
                            {username: "Tiancum", age: 43},
                            {username: "Jacob", age: 27},
                            {username: "Nephi", age: 29},
                            {username: "Enos", age: 34},
                            {username: "Tiancum", age: 43},
                            {username: "Jacob", age: 27},
                            {username: "Nephi", age: 29},
                            {username: "Enos", age: 34},
