...
<div ng-controller="DemoCtrl">
    ...
    <table ng-table-dynamic="tableParams with cols" show-filter="true" class="table table-bordered table-striped">
        <tr ng-repeat="user in $data">
            ...
            <td title="cols[0].title" ng-show="cols[0].show">{{user[cols[0].field]}}</td>
            <td title="cols[1].title" ng-show="cols[1].show" class="text-danger">{{user[cols[1].field]}}</td>
        </tr>
    </table>
