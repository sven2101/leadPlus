...
public enum LicenseEnum {
	ERROR("error", new HashSet<String>(Arrays.asList("/components/Common/view/NotFound.html",
			...
			0), FREE("free",
					new HashSet<String>(Arrays.asList("/", "/console/**", "/health", "/images/favicon/**", "/assets/**",
							"/fonts/**", "/app/**", "/components/Login/view/Login.html", "/logout",
							"/password/forgot/**", "/logout.html", "/401.html", "/403.html", "/404.html",
							...
							"/swagger-resources", "/v2/api-docs/**", "/configuration/security", "/components/**",
							"/main.html", "/registrations", "/registrations/**", "/tenants", "/tenants/**",
