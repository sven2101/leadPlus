	...
	ERROR("error", new HashSet<String>(Arrays.asList("/components/Common/view/NotFound.html",
			...
			0), FREE("free",
					new HashSet<String>(Arrays.asList("/", "/console/**", "/health", "/images/favicon/**", "/assets/**",
							"/fonts/**", "/app/**", "/components/Login/view/Login.html", "/logout", "/logout.html",
							"/401.html", "/403.html", "/404.html", "/components/Signup/view/Signup.html",
							...
							"/v2/api-docs/**", "/configuration/security", "/api/rest/files/pdf")),
					1), BASIC("basic",
