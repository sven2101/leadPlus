...
public enum LicenseEnum {
	ERROR("error", new HashSet<String>(Arrays.asList("/components/Common/view/NotFound.html",
			...
			0), FREE("free", new HashSet<String>(Arrays.asList("/", "/console/**", "/health", "/images/favicon/**",
					...
					"/Password.html", "/Password.Reset.html", "/logout.html", "/401.html", "/403.html", "/404.html",
					...
					"/api/rest/registrations/**", "/api/rest/password/forgot", "/components/Common/view/NotFound.html",
					"/components/Common/view/Unauthorized.html", "/components/Common/view/Forbidden.html",
					"/swagger-ui.html", "/webjars/springfox-swagger-ui/**", "/configuration/ui", "/swagger-resources",
