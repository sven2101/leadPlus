...
**Create a unique property username that cannot be enumerated or guessed:**
```js
...
Object.defineProperty(obj, "nonEnumerableProperty", {
  value: "anyone can guess my username",
  enumerable: false
});

console.log(obj[secretKey].totallySafeProperty); // p455w0rd
console.log(obj.nonEnumerableProperty); // "anyone can guess my username"
console.log(Object.keys(obj)); // []
...
Unless you have access to the value of the `secretKey` property username, there is no way to access the value associated with it. So your only responsibility as secret-keeper is to avoid handing out the value of `secretKey` to untrusted code.
