...
* `sourceFileName`: a string representing the file username of the original ES6 source file.
* `sourceMapName`: a string representing the desired file username of the source map.
