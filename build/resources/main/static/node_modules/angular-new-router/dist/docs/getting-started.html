...
<pre><code class="lang-html"><span class="tag">&lt;<span class="title">h1</span>&gt;</span>Hello {{home.username}}!<span class="tag">&lt;/<span class="title">h1</span>&gt;</span>
</code></pre>
<p>Components use the &quot;controller as&quot; syntax, so if we want to access property <code>username</code> of the controller, we write the binding as <code>home.username</code>.</p>
...
<pre><code class="lang-js"><span class="identifier">angular</span>.<span class="identifier">module</span>(<span class="string">'app.home'</span>, [])
  .<span class="identifier">controller</span>(<span class="string">'HomeController'</span>, [<span class="keyword">function</span> () {
    <span class="control-flow">this</span>.<span class="identifier">username</span> <span class="operator">=</span> <span class="string">'Friend'</span>;
  }]);
</code></pre>
<p>To wire this up, We need to add a <code>&lt;script&gt;</code> tag to our <code>index.html</code>:</p>
<pre><code class="lang-html">...
<span class="tag">&lt;<span class="title">script</span> <span class="attribute">src</span>=<span class="value">"./components/home/home.js"</span>&gt;</span><span class="javascript"></span><span class="tag">&lt;/<span class="title">script</span>&gt;</span>
</code></pre>
